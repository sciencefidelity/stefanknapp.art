<template>
  <div class={props.modal ? "modalContainer hideModal" : "modalContainer"}>
    <div class="btnPrev" onClick={props.prevIndex}>
      <img
        alt="Previous image"
    ...
    <div class="btnNext" onClick={props.nextIndex}>
      <img
        alt="Next image"
    ...
    <div class="handleClose" onClick={props.closeModal}></div>
    <div class="modalClose" onClick={props.closeModal}>
      <img
        alt="Close lightbox"
